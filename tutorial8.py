...
background=pygame.image.load("H:\python fun\Pygame\gameroad.png")
pygame.mixer.music.load("H:\python fun\Pygame\car-interior-1.mp3") 
...
class Player():
    def __init__(self):
        self.image=pygame.image.load("H:\python fun\Pygame\car.png")
    ...
    def moveLeft(self):
        ...
        pygame.mixer.music.load("H:\python fun\Pygame\TIRE_SKID.mp3") 
...
class Enemy():
    def __init__(self):
        self.image=pygame.image.load("H:\python fun\Pygame\enemy.png")
        self.surf = pygame.Surface((50, 80))
...
pygame.mixer.Channel(1).play(pygame.mixer.Sound('H:\python fun\Pygame\car-interior-1.mp3'))
